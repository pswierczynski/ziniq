...
jQuery(document).ready(function($){
  ...
  $(".icons-grid").each(function() {
    var $lis = $('.icon-box', this);
    if ($lis.length > 5) {
      $(this).append('<div class="icon-box li_more"><div class="icon"> <img src="assets/img/Group-620.svg" class="img-fluid" alt=""> </div> <p>Więcej</p> </div>')
      $(this).append('<div class="icon-box li_off li_hide"><div class="icon"> <img src="assets/img/Group-620.svg" class="img-fluid" alt=""> </div> <p>Mniej</p> </div>')
    }
    if ($lis.length > 5) {
      $lis.slice(5).addClass("li_off");
      $(".li_more").on("click", function() {
        $(this).siblings().addClass('li_show');
        $(this).addClass('li_off');
        $(this).removeClass('li_show');
      });
      $(".li_hide", this).on("click", function() {
        $(this).siblings().removeClass('li_show');
        $(this).removeClass('li_show');
        $(this).addClass('li_off');
        $(this).parent().find(".li_more").addClass('li_show');
      });
    }
  });
